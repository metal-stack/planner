 ...
 *  only when both ends remain and belong to the shown network. An external
 *  network whose attachment points all fell away (a storage network on
 *  storage leaves, in central mode) goes with them instead of floating
 *  unconnected. */
